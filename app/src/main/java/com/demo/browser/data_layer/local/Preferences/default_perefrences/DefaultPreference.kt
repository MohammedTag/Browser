...
class DefualtPreferenceModule {
    ...
    @Singleton
    @Provides
    fun providesDefualtPreference(appContext: Context): SharedPreferences =
        PreferenceManager.getDefaultSharedPreferences(appContext)

    @Named(value = PreferencesConstants.DaggerNamedValues.DEFAULT_PREFERENCE)
    @Singleton
    @Provides
    fun providesEncryptedPreferences(sharedPreferences: SharedPreferences): PreferencesSource =
